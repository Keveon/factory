...
if (!DevExpress.MOD_WIDGETS_BASE) {
    ...
    (function ($, DX, undefined) {
        ...
        $.extend(ui.dxMap.__internals, {
            remapBingConstant: function (newValue) {
                BING_URL = newValue
            }
        })
    })(jQuery, DevExpress);
    ...
    (function ($, DX, undefined) {
        ...
        if (!ui.dxMap.__internals)
            ui.dxMap.__internals = {};
        $.extend(ui.dxMap.__internals, {
            remapGoogleConstant: function (newValue) {
                GOOGLE_URL = newValue
            }
        })
    })(jQuery, DevExpress);
    ...
    (function ($, DX, undefined) {
        ...
        if (!ui.dxMap.__internals)
            ui.dxMap.__internals = {};
        $.extend(ui.dxMap.__internals, {
            remapGoogleStaticConstant: function (newValue) {
    ...
    (function ($, DX, undefined) {
        ...
        registerDecorator("delete", "toggle", SwitchableButtonDeleteDecorator.inherit({
        ...
        registerDecorator("selection", "item", ui.ListEditDecoratorsRegistry.selection.control.inherit({
            handleClick: function ($itemElement) {
        ...
        DX.registerComponent("dxDateBox", ui.dxTextEditor.inherit({
            ...
            _renderDatePicker: function () {
                ...
                if (this._datePicker)
                    ...
                    this._datePicker = $("<div>").appendTo(this._element()).dxDatePicker($.extend(datePickerOptions, {
                        hidingAction: $.proxy(function (e) {
                            this.option("value", e.component.option("value"))
                        }, this)
                    })).dxDatePicker("instance");
