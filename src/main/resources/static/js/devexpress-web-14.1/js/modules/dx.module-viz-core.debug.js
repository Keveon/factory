...
if (!DevExpress.MOD_VIZ_CORE) {
    ...
    (function ($, DX) {
        ...
        core.LoadIndicator = DX.Class.inherit({
            ...
            _updateRenderer: function (width, height, top) {
                ...
                this._renderer && this._renderer.getRoot().applySettings({
                    style: {
                        position: 'absolute',
                        top: top,
                        left: 0
    ...
    (function ($, DX) {
        ...
        series.fullstackedline = _extend({}, series.line, {
            _getRangeData: function (zoomArgs, calcIntervalFunction) {
    ...
    (function ($, DX) {
        ...
        series.steparea = _extend({}, series.area, {
            _prepareSegment: function (points, rotated) {
    ...
    (function ($, DX) {
        ...
        series.stackedline = _extend({}, lineSeries, baseStackedSeries, {
            _getRangeData: function () {
                this._processStackedRange();
                return lineSeries._getRangeData.apply(this, arguments)
            }
        });
        series.fullstackedline = _extend({}, lineSeries, baseFullStackedSeries, {
            _getRangeData: function (zoomArgs, calcIntervalFunction) {
                this._processStackedRange();
                var rangeCalculator = viz.core.series.helpers.rangeDataCalculator();
                rangeCalculator.calculateRangeData(this, zoomArgs, calcIntervalFunction);
    ...
    (function ($, DX) {
        ...
        DX.viz.core.registerTheme({
            name: 'win8-white',
            chart: $.extend(true, {}, baseWhiteChartTheme, {
                commonAxisSettings: {
                    title: {font: {color: '#939393'}},
                    label: {
                        font: {
    ...
    (function ($, DX) {
        ...
        var TspanSvgElement = BaseSvgElement.inherit({
            ctor: function (renderer, params) {
    ...
    (function ($, DX) {
        ...
        var PathVmlElement = svgRendererInternals.PathSvgElement.inherit(BaseVmlElement).inherit(BasePathVmlElement).inherit({
            prepareSegments: function (settings) {
                var that = this,
        ...
        var ArcVmlElement = svgRendererInternals.ArcSvgElement.inherit(BaseVmlElement).inherit(BasePathVmlElement).inherit({
            createArcSegments: function (x, y, innerR, outerR, startAngle, endAngle, isCircle) {
    ...
    (function ($, DX, undefined) {
        ...
        DX.viz.core.BaseWidget = DX.DOMComponent.inherit({
            ...
            _setDefaultOptions: function () {
                this.callBase();
                this.option({
                    incidentOccured: function (options) {
