...
if (!window.DevExpress) {
    ...
    (function ($, DX, undefined) {
        ...
        var registerComponent = function (name, componentClass) {
            componentClass.redefine({
                _attachInstanceToElement: function ($element) {
    ...
    (function ($, DX, undefined) {
        ...
        var KoComponent = DX.DOMComponent.inherit({
    ...
    (function ($, DX, undefined) {
        ...
        var DEFAULT_ITEM_TEMPLATE_GENERATORS = {
            base: function () {
